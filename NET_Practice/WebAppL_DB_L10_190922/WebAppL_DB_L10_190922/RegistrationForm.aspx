<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationForm.aspx.cs" Inherits="WebAppL_DB_L10_190922.RegistrationForm" %>
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Name">
                              ...
                              <asp:TemplateField HeaderText="City">
                                <ItemTemplate>
                                    <%#Eval("city") %>  <%-- This is SQL table Column name, So it would be either in samll or capital--%>
                                </ItemTemplate>
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Salary">
                                <ItemTemplate>
                                    <%#Eval("salary") %>  <%-- This is SQL table Column name, So it would be either in samll or capital--%>
                                </ItemTemplate>
                            </asp:TemplateField>
