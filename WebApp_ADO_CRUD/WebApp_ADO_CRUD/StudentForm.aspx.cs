...
namespace WebApp_ADO_CRUD
{
    public partial class StudentForm : System.Web.UI.Page
    {
        SqlConnection con = new SqlConnection("data source=LTIN254607; initial catalog =DBP060322; integrated security=true");
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("sp_gett_Student", con);
            cmd.CommandType = CommandType.StoredProcedure;
